...
function Experience() {
  ...
  return (
    <>
      <section id="Experience" className="py-4 py-lg-5 my-5 position-relative">
        <div className="container position-relative py-lg-5">
          ...
          <button className="ff_jakarta fw-semibold text-white fs_md amd_btn mt-1 z_index1 rounded-2 ms-3 ">
